...
const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || 'https://api-production-5f3c.up.railway.app';
...
File: ${r.file}
Grade: ${(r.result.evaluation?.score ?? 0) >= 8.5 ? 'A' : (r.result.evaluation?.score ?? 0) >= 7 ? 'B' : 'C'}
